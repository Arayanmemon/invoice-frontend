...
export function AuthenticatedLoginPage({ onBack, onSuccess }: AuthenticatedLoginPageProps) {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex flex-col justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-pink-500 text-white w-3/5 px-10 py-12 relative overflow-hidden h-auto">
